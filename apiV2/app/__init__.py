...
def initialize_app(config_name="development"):
    ...
    app.register_blueprint(driver_route, url_prefix="/api/v2/driver")
    app.register_blueprint(user_route,url_prefix="/api/v2/user")
    app.register_blueprint(user_driver_route,url_prefix="/api/v2")
